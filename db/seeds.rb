...
lola = User.create(username: "l00000l", name: "Lolla Palolla", age: 22, bio: "Like oh my gosh! I just looooooove romantic comedies.", profile_pic: "/user-images/lolla-blonde.jpeg")
bob = User.create(username: "bob_da_builder", name: "Robert D. Builder", age: 37, bio: "Handyman at your service. HGTV & action movies all day, er' day", profile_pic: "/user-images/bob-the-builder.jpg")
rob = User.create(username: "movie_crit101", name: "Robert Q. Smythe", age: 35, bio: "A professional movie critic.", profile_pic: "/user-images/critic-rob.jpeg")
...
twilight = Movie.create(title: "Twilight", year: 2008, genre: "Romance", plot: " High-school student Bella Swan, always a bit of a misfit, doesn't expect life to change much when she moves from sunny Arizona to rainy Washington state.", poster: "https://tvguide1.cbsistatic.com/rovi/showcards/movie/295116/16915691.jpg") 
jumanji = Movie.create(title: "Jumanji: Welcome to the Jungle", year: 2017, genre: "Comedy", plot: "Four teens get sucked into the video game world of Jumanji and have to finish the dangerous game to escape.", poster: "https://m.media-amazon.com/images/M/MV5BODQ0NDhjYWItYTMxZi00NTk2LWIzNDEtOWZiYWYxZjc2MTgxXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_.jpg") 
upside = Movie.create(title: "The Upside", year: 2017, genre: "Comedy", plot: "A recently paroled ex-convict who strikes up an unlikely friendship with a paralyzed billionaire.", poster: "https://m.media-amazon.com/images/M/MV5BNzY3NzYyNjI0N15BMl5BanBnXkFtZTgwNjYzMDc0NjM@._V1_.jpg") 
ci = Movie.create(title: "Central Intelligence", year: 2016, genre: "Action", plot: "Bullied as a teen for being overweight, Bob Stone shows up to his high school reunion looking fit and muscular.", poster: "https://pisces.bbystatic.com/image2/BestBuy_US/images/products/3351/33513153_so.jpg") 
cmarvel = Movie.create(title: "Captain Marvel", year: 2019, genre: "Action", plot: "Captain Marvel is an extraterrestrial Kree warrior who finds herself caught in the middle of an intergalactic battle between her people and the Skrulls.", poster: "https://m.media-amazon.com/images/M/MV5BMTE0YWFmOTMtYTU2ZS00ZTIxLWE3OTEtYTNiYzBkZjViZThiXkEyXkFqcGdeQXVyODMzMzQ4OTI@._V1_.jpg") 
sleepover = Movie.create(title: "Sleepover", year: 2004, genre: "Romance", plot: "A teen girl’s sleepover turns into a madcap midnight scavenger hunt to win the prize of the popular kids’ high school lunch table and the boy of her dreams.", poster: "https://tvguide1.cbsistatic.com/feed/1/395/thumbs/100442395_1300x1733.jpg") 
diehard = Movie.create(title: "Live Free or Die Hard", year: 2007, genre: "Action", plot: " As the nation prepares to celebrate Independence Day, veteran cop John McClane carries out another routine assignment: bringing in a computer hacker for questioning.", poster: "https://m.media-amazon.com/images/M/MV5BNDQxMDE1OTg4NV5BMl5BanBnXkFtZTcwMTMzOTQzMw@@._V1_.jpg") 
split = Movie.create(title: "Split", year: 2016, genre: "Horror", plot: "Though Kevin has evidenced 23 personalities to his trusted psychiatrist, Dr. Fletcher, there remains one still submerged who is set to materialize and dominate all the others.", poster: "https://m.media-amazon.com/images/M/MV5BZTJiNGM2NjItNDRiYy00ZjY0LTgwNTItZDBmZGRlODQ4YThkL2ltYWdlXkEyXkFqcGdeQXVyMjY5ODI4NDk@._V1_.jpg") 
xmen = Movie.create(title: "X-Men: First Class", year: 2011, genre: "Action", plot: "Before they became the worst of enemies, Charles Xavier and Erik Lehnsherr were the best of friends.", poster: "https://mlpnk72yciwc.i.optimole.com/w:auto/h:auto/q:auto/http://www.bleedingcool.com/wp-content/uploads//2011/05/209729_207965225902840_167023033330393_655142_3901786_o.jpg") 
